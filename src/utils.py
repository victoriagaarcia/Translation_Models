...
def load_model(name: str, device: torch.device) -> RecursiveScriptModule:
    """
...
def save_vocab(vocab: Dict[str, int], name: str) -> None:
    """
    Function to save the vocabulary as a json file.
...
def load_vocab(name: str) -> Dict[str, int]:
    """
    Function to load the vocabulary from a json file.
